...
.buttonBlue { background-color: #0000FF; border: 2px solid #000000;; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; }
...
<br><br>
<center> <button class="buttonBlue" name="led" value="toggle" type="submit">LED BLINK</button>
</form>
<br><br>
<br><br>
<p>%s<p></body></html>
...
while True:
    try:       
        ...
        led_blink = request.find('led=toggle')
